...
if __name__ == '__main__':
    ...
    mutationProbability  = .15 # Probability of mutation
    mutationScale = 0.11 # Standard deviation of the gaussian noise
    numIterations = 3300 # Number of iterations to run the genetic algorithm for
    ...
    numIterations = 4000 # Number of iterations to run the genetic algorithm for
    errorTreshold = 1e-8 # Lower threshold for the error while optimizing
    """
    ...
    populationSize = 20 # The number of chromosomes
    mutationProbability  = .15 # Probability of mutation
    mutationScale = 0.6 # Standard deviation of the gaussian noise
    numIterations = 2700 # Number of iterations to run the genetic algorithm for
    errorTreshold = 1e-8 # Lower threshold for the error while optimizing
    """
